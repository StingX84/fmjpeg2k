...
MAKE_FMJPEG2K_ERROR( 3, J2KCodecUnsupportedImageType, "Codec does not support this JPEG-2000 image");
...
MAKE_FMJPEG2K_ERROR( 9, J2KUnsupportedBitDepth, "Unsupported bit depth in JPEG-2000 transfer syntax");
MAKE_FMJPEG2K_ERROR(10, J2KCannotComputeNumberOfFragments, "Cannot compute number of fragments for JPEG-2000 frame");
MAKE_FMJPEG2K_ERROR(11, J2KImageDataMismatch, "Image data mismatch between DICOM header and JPEG-2000 bitstream");
MAKE_FMJPEG2K_ERROR(12, J2KUnsupportedPhotometricInterpretation, "Unsupported photometric interpretation for near-lossless JPEG-2000 compression");
MAKE_FMJPEG2K_ERROR(13, J2KUnsupportedPixelRepresentation, "Unsupported pixel representation for near-lossless JPEG-2000 compression");
MAKE_FMJPEG2K_ERROR(14, J2KUnsupportedImageType, "Unsupported type of image for JPEG-2000 compression");
